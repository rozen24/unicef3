...
পরীক্ষাকে জীবনের একটি অংশ হিসেবে গ্রহণ করার মানসিকতা অর্জনের চেষ্টা করতে হবে।`,
        ...
        lessons: [
          ...
          },
          {
            ...
            content: (function () {
              ...
              return `
                <div class="lesson-slide mod20-lesson mod20-lesson-2">
                  <div class="mod20-shapes">
                    <span class="mod20-shape mod20-shape--orb"></span>
                    <span class="mod20-shape mod20-shape--ring"></span>
                    <span class="mod20-shape mod20-shape--triangle"></span>
          ...
          },
          {
            ...
            content: (function () {
              ...
              return `
                <div class="lesson-slide mod20-lesson mod20-lesson-5">
                  <div class="mod20-shapes">
                    <span class="mod20-shape mod20-shape--orb"></span>
                    <span class="mod20-shape mod20-shape--ring"></span>
                    <span class="mod20-shape mod20-shape--triangle"></span>
          ...
          },
          {
            ...
            content: (function () {
              ...
              return `
                <div class="lesson-slide mod20-lesson mod20-lesson-9">
                  <div class="mod20-shapes">
                    <span class="mod20-shape mod20-shape--orb"></span>
                    <span class="mod20-shape mod20-shape--ring"></span>
                    <span class="mod20-shape mod20-shape--triangle"></span>
          ...
          },
          {
            ...
            content: (function () {
              ...
              return `
                <div class="lesson-slide mod20-lesson mod20-lesson-10">
                  <div class="mod20-shapes">
                    <span class="mod20-shape mod20-shape--orb"></span>
                    <span class="mod20-shape mod20-shape--ring"></span>
                    <span class="mod20-shape mod20-shape--triangle"></span>
          ...
          },
          {
            ...
            content: (function () {
              ...
              return `
                <div class="lesson-slide mod20-lesson mod20-lesson-13">
                  <div class="mod20-shapes">
                    <span class="mod20-shape mod20-shape--orb"></span>
                    <span class="mod20-shape mod20-shape--ring"></span>
                    <span class="mod20-shape mod20-shape--triangle"></span>
          ...
          },
          {
            ...
            content: (function () {
              ...
              return `
                <div class="lesson-slide mod20-lesson mod20-lesson-15">
                  <div class="mod20-shapes">
                    <span class="mod20-shape mod20-shape--orb"></span>
                    <span class="mod20-shape mod20-shape--ring"></span>
                    <span class="mod20-shape mod20-shape--diamond"></span>
          ...
          },
          {
            ...
            content: (function () {
              ...
              const healthProblems = [
                yhLang("Severe vomiting, diarrhea", "তীব্র বমি, ডায়রিয়া"),
                yhLang("Skin diseases", "চর্মরোগ"),
                yhLang("Cancer", "ক্যান্সার"),
                yhLang("Heart disease", "হৃদরোগ"),
              ...
              return `
                <div class="lesson-slide mod22-lesson7">
                  <div class="m22l7-shapes" aria-hidden="true">
                    <span class="m22l7-shape m22l7-shape--circle"></span>
                    <span class="m22l7-shape m22l7-shape--square"></span>
                    <span class="m22l7-shape m22l7-shape--hexagon"></span>
                  </div>

                  <header class="m22l7-hero d-none"  data-aos="fade-down">
                    <div class="m22l7-hero__badge">
                      <i class="fa-solid fa-flask"></i>
                    </div>
                    <h1 class="m22l7-hero__title">${yhLang("Lead and Other Hazardous Chemicals", "সীসা এবং অন্যান্য বিপজ্জনক রাসায়নিক")}</h1>
                    <p class="m22l7-hero__subtitle">${yhLang("Health risks and prevention strategies", "স্বাস্থ্য ঝুঁকি এবং প্রতিরোধ কৌশল")}</p>
                  </header>

                  <section class="m22l7-intro-section" data-aos="fade-up" data-aos-delay="150">
                    <div class="m22l7-section-header">
                      <div class="m22l7-section-icon m22l7-section-icon--chemicals">
                        <i class="fa-solid fa-flask"></i>
                      </div>
                      <h2 class="m22l7-section-title">${yhLang("Lead and Other Hazardous Chemicals", "সীসা এবং অন্যান্য বিপজ্জনক রাসায়নিক")}</h2>
                    </div>
                  ...
                  <section class="m22l7-chemicals-section" data-aos="fade-up" data-aos-delay="280">
                    <div class="m22l7-section-header">
                      <div class="m22l7-section-icon m22l7-section-icon--chemicals">
                  ...
                  <section class="m22l7-health-section" data-aos="fade-up" data-aos-delay="400">
                    <div class="m22l7-section-header">
                      <div class="m22l7-section-icon m22l7-section-icon--health">
                        <i class="fa-solid fa-heart-pulse"></i>
                      </div>
                      <h2 class="m22l7-section-title">${yhLang("Health Problems Associated with Hazardous Chemicals", "ক্ষতিকারক রাসায়নিক পদার্থের সাথে সম্পর্কিত স্বাস্থ্য সমস্যা")}</h2>
                    </div>
                    <ul class="m22l7-health-grid">
                      ${renderHealthProblems(healthProblems, 480)}
                    </ul>
                  </section>

                  <section class="m22l7-prevention-section" data-aos="fade-up" data-aos-delay="520">
                    <div class="m22l7-section-header">
                      <div class="m22l7-section-icon m22l7-section-icon--prevention">
                        <i class="fa-solid fa-shield-heart"></i>
                      </div>
                      <h2 class="m22l7-section-title">${yhLang("Prevention and Management", "প্রতিরোধ ও ব্যবস্থাপনা")}</h2>
                    </div>
                    <ul class="m22l7-prevention-list">
                      ${renderPrevention(preventionMeasures, 600)}
                    </ul>
                  </section>
                </div>`;
            })(),
      ...
      },
      {
        ...
        lessons: [
          {
            id: "ch24-lesson-1",
            title: yhLang("Life Skills", "জীবন দক্ষতা"),
            icon: "fa-sprout",
            ...
            content: (function () {
              ...
              return `
                <div class="lesson-slide mod24-lesson1">
                  <div class="m24l1-shapes" aria-hidden="true">
                    <span class="m24l1-shape m24l1-shape--orb"></span>
